            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" value="<?php echo set_value('name'); ?>" class="form-control" id="name" autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="price" value="<?php echo set_value('price'); ?>" class="form-control" id="price" autocomplete="off">
                  </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="stock" value="<?php echo set_value('stock'); ?>" class="form-control" id="stock" autocomplete="off">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="unit" value="<?php echo set_value('unit'); ?>" class="form-control" id="unit" autocomplete="off">
                      <?php echo form_error('unit'); ?>
                    </div>
                  </div>
                </div>
                   <div class="form-group">
                     <label class="form-control-label" for="pic">Gambar</label>
                     <input type="file" name="picture" class="form-control" id="pic">
                     <small class="text-muted">*Pilih gambar JPG/PNG dengan ukuran maksimal 2MB</small>
                   </div>
