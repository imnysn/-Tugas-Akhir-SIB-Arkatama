    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <h1 class="mb-0 bread"><mark>Detail Produk</mark></h1>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="row">
              ...
              <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                  ...
                  <div class="rating d-flex">
                          ...
                          <p class="text-left mr-4">
                              <a href="#" class="mr-2" style="color: #000;">100 <span style="color: #bbb;">Ulasan</span></a>
                          </p>
                          <p class="text-left">
                              <a href="#" class="mr-2" style="color: #000;">500 <span style="color: #bbb;">Terjual</span></a>
                          </p>
                      </div>
                  <p class="price">
            ...
            <p><a href="#" class="btn btn-black btn-sm py-3 px-5 add-cart cart-btn" data-sku="<?php echo $product->sku; ?>" data-name="<?php echo $product->name; ?>" data-price="<?php echo ($product->current_discount > 0) ? ($product->price - $product->current_discount) : $product->price; ?>" data-id="<?php echo $product->id; ?>">Masukan Keranjang</a></p>
              </div>
          </div>
      </div>
  </section>
