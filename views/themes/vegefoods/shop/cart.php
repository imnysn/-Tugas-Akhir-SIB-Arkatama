    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <h1 class="mb-0 bread"><mark>Keranjang Belanja</mark></h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
                          ...
                          <tbody>
                              ...
                              <td class="quantity">
                                  <div class="input-group mb-3">
                                   <input type="text" name="quantity[<?php echo $item['rowid']; ?>]" class="quantity form-control input-number" value="<?php echo $item['qty']; ?>" min="0" max="100">
                                </div>
                            </td>
                              
                              <td class="total">Rp <?php echo format_rupiah($item['subtotal']); ?></td>

                              <td class="product-remove"><a href="#" class="remove-item" class="btn btn-danger btn-xs" data-rowid="<?php echo $item['rowid']; ?>"><span class="fa fa-trash"></span></a></td>
                            </tr>
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <center>
                <div class="alert alert-info">Tidak ada barang dalam keranjang dan mulailah berbelanja!</div>
              </center>
              </div>
            </div>
          <?php endif; ?>
