    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread"><mark>Temukan Kami</mark></h1>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
        ...
        <div class="col-md-3 d-flex">
            <div class="info bg-white p-4">
              ...
              Jl. Prof. M. Yamin Kel. Duren Jaya Kec. Bekasi Timur Kota Bekasi</p>
              </center>
            </div>
        </div>
        <div class="col-md-3 d-flex">
        ...
        <div class="col-md-6 order-md-last d-flex">
          ...
          <?php endif; ?>
            ...
            <div class="form-group">
              <input type="text" name="name" class="form-control" value="<?php echo set_value('name', (is_login() ? get_user_name() : '')); ?>" placeholder="Nama" required autocomplete="off"> <?php echo form_error('name'); ?>
            </div>
            <div class="form-group">
              <input type="email" name="email" class="form-control" value="<?php echo set_value('email', (is_login() ? $user->email : '')); ?>" placeholder="Email" required autocomplete="off"> <?php echo form_error('email'); ?>
            </div>
            <div class="form-group">
