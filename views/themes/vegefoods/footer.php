    ...
    <div class="container">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="<?php echo site_url('pages/contact'); ?>" class="py-2 d-block">Kontak</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">0813-8365-8219</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">tokosayur22@gmail.com</span></a></li>
                  <li><span class="icon icon-map-marker"></span><span class="text">Jl Prof M. Yamin Kel. Duren Jaya Kec. Bekasi Timur Kota Bekasi</span></li>
                </ul>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Imran Yusran</i></p>
        </div>
      </div>
    </div>
  </footer>
